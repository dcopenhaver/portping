...
- **Inspection Mode**: Detect proxy interception and network anomalies with `--inspect`
  - **Layer 7 Protocol Detection**: Automatically identifies TLS, HTTP, MySQL, PostgreSQL, RDP, SMB, and more
...
3. **Layer 7 Probing**: Tests TLS, HTTP, MySQL, PostgreSQL, RDP, SMB protocols (1000ms per protocol)
...
- Layer 7 protocol detected (TLS, HTTP, MySQL, PostgreSQL, RDP, SMB)
